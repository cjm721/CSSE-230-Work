 ...
 * can attack a given square on the board. Each queen is responsible for
 * negotiating with its neighbors to find a non-attacking configuration.
 * 
...
public interface Queen {
	...
	/**
	 * Checks whether this queen or one of its neighbors can attack the given
	 * row and column.
	 * 
	 * @param row
	 * @param col
	...
	/**
	 * @return a string representing the rows in which this queen and its
	 *         neighbors. are placed
	 */
